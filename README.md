...
- 🔍 **Automated Recon** — nmap, whois, whatweb, curl headers, dig DNS, nikto, sslscan, testssl.sh (TLS/SSL config audit)
...
```
  ...
  [7] sslscan
  [8] testssl.sh
  [a] Run all (except nikto, sslscan, testssl.sh)
